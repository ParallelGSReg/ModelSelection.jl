function to_dict(data::ModelSelectionData; kwargs...)
    ...
    for result in data.results
        ...
        elseif typeof(result) == ModelSelection.AllSubsetRegression.AllSubsetRegressionResult
            summary[:allsubsetregression] = ModelSelection.AllSubsetRegression.to_dict(data, result)
        end
    end
    return summary
end
