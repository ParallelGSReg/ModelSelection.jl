...
const AVAILABLE_CRITERIA = Dict(
    :aic => Dict("verbose_title" => "AIC", "verbose_show" => true, "index" => -1, "order" => 1),
    :aicc =>
        Dict("verbose_title" => "AIC Corrected", "verbose_show" => true, "index" => -1, "order" => 2),
    :bic => Dict("verbose_title" => "BIC", "verbose_show" => true, "index" => -1, "order" => 3),
    :cp =>
        Dict("verbose_title" => "Mallows's Cp", "verbose_show" => true, "index" => -, "order" => 4),
    :loglikelihood => Dict(
    ...
    :r2adj =>
        Dict("verbose_title" => "Adjusted R²", "verbose_show" => false, "index" => 1, "order" => 6),
    :rmse => Dict("verbose_title" => "RMSE", "verbose_show" => true, "index" => -1, "order" => 7),
    :rmseout =>
        Dict("verbose_title" => "RMSE OUT", "verbose_show" => true, "index" => -1, "order" => 8),
    :roc => Dict("verbose_title" => "ROC", "verbose_show" => true, "index" => -1, "order" => 9),
    :sse => Dict("verbose_title" => "SSE", "verbose_show" => true, "index" => -1, "order" => 10),
)
